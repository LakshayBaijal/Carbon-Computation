...
# It’s a Script used to convert Energy production to Carbon intensity data using energy source provided by IPCC study.
EMISSIONS_IPCC = dict(
    # Renewable
    biopower=18,
    solar_pv=46,
...
#literature review of life cycle of total energy sources CO2 emissions per unit electricity generation.
# Mapping 
CA_MAP = {  # WNA_map
    "Solar": EMISSIONS_IPCC["solar_pv"],
...
#stores the dictionary of values on Productivity Rate and CO2 emissions of Renewable 
